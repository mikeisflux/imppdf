...
export const OP_GROUPS: OpGroup[] = [
  ...
  { label: '// ADVANCED', ops: [
    ...
    { id: 'divinitycards', label: 'Divinity Trading Cards', icon: 'cards', tip: 'Standard 2.5 \u00d7 3.5" trading cards, eight to an A4 fed long edge first, and the A4 block duplicated onto an A3 \u2014 so one sheet gives sixteen and cuts across the middle into two A4s you can run. Fixed 3 mm gutters, positions symmetric so fronts and backs register. Upload one card, or two pages for front and back.' },
    { id: 'divinitydeck', label: 'Divinity Trading Card Deck', icon: 'cards', tip: 'A whole deck out of one file — one card per page, the last page the shared back — ganged eight to an A4 fed LONG EDGE FIRST, cards upright the way the cutter takes them, over as many sheets as the deck needs. No duplex: every front prints, then every back, so you can run heavy stock in two passes.' },
