...
export const OP_GROUPS: OpGroup[] = [
  ...
  { label: '// ADVANCED', ops: [
    ...
    { id: 'divinitycards', label: 'Divinity Trading Cards', icon: 'cards', tip: 'The shop\u2019s card template, to the printer\u2019s spec: a 54 \u00d7 90 mm card, ten to an A4, and the A4 block doubled onto an A3 so one sheet gives twenty and cuts down the middle into two A4s. Fixed 3 mm gutters and 13.5 / 7.5 mm margins \u2014 upload one card and it fills the sheet.' },
