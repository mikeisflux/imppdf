...
export const OP_GROUPS: OpGroup[] = [
  ...
  { label: '// ADVANCED', ops: [
    ...
    { id: 'divinitycards', label: 'Divinity Trading Cards', icon: 'cards', tip: 'Standard 2.5 \u00d7 3.5" trading cards, nine to an A4 and the A4 block doubled onto an A3 \u2014 so one sheet gives eighteen and cuts down the middle into two A4s. Fixed 3 mm gutters, positions symmetric so fronts and backs register. Upload one card, or two pages for front and back.' },
