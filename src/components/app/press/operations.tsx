...
export const OP_GROUPS: OpGroup[] = [
  ...
  { label: '// ADVANCED', ops: [
    ...
    { id: 'divinitydeck', label: 'Divinity Trading Card Deck', icon: 'cards', tip: 'A whole deck out of one file — one card per page, the last page the shared back — ganged nine to an A4 fed LONG EDGE FIRST, over as many sheets as the deck needs. No duplex: every front prints, then every back, so you can run heavy stock in two passes.' },
