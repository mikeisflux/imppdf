...
export const TRADING_CARD_W_IN = 2.5;
export const TRADING_CARD_H_IN = 3.5;
export const TRADING_CARD_SHEET_W_IN = 8.5;
export const TRADING_CARD_SHEET_H_IN = 11;

/** How this piece is actually produced on press — the thing that decides the
 *  gutter, and therefore the count. Butt-cut: 9-up on Letter, the standard uncut sheet. */
export const TRADING_CARD_DEFAULTS = {
  marginIn: 0.25,
  gutterXIn: 0,
  gutterYIn: 0,
  buttCut: true,
...
export const TRADING_CARD_TOOL = 'trading';

export function fitTradingCard(
  spec: SheetSpec, pieceWIn = TRADING_CARD_W_IN, pieceHIn = TRADING_CARD_H_IN,
): SheetFit {
  return packBestOrientation({ ...TRADING_CARD_DEFAULTS, ...spec }, pieceWIn, pieceHIn, 'trading card');
}
