...
export const BOOKMARK_W_IN = 2;
export const BOOKMARK_H_IN = 6;
export const BOOKMARK_SHEET_W_IN = 8.5;
export const BOOKMARK_SHEET_H_IN = 11;

/** How this piece is actually produced on press — the thing that decides the
 *  gutter, and therefore the count. Butt-cut strips. */
export const BOOKMARK_DEFAULTS = {
  marginIn: 0.25,
  gutterXIn: 0,
  gutterYIn: 0,
  buttCut: true,
...
export function fitBookmark(
  spec: SheetSpec, pieceWIn = BOOKMARK_W_IN, pieceHIn = BOOKMARK_H_IN,
): SheetFit {
  return packBestOrientation({ ...BOOKMARK_DEFAULTS, ...spec }, pieceWIn, pieceHIn, 'bookmark');
}
